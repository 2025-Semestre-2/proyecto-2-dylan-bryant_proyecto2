...
<script>
    ...
    export default{
        ...
        methods:{
            buscar(){
            const url = `${this.link}/stats/cuartaEstadistica?anio=${encodeURIComponent(this.filtro)}&anioFin=${encodeURIComponent(this.filtro2)}&sucursal=${encodeURIComponent(this.sucursalSeleccionada)}`;
